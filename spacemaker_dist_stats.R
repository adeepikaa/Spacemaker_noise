...
# arguments get both *npy files src, bldg
# for the purposes of the distance features, each building has been treated as a collection of buildings at adjacent locations
create_dist_stats <- function(x,y) {
  ...
  # get building coverage for 4 buffer zones to portray density
  ...
  # get average building height for 4 buffer zones 
  ...
  # get maximum building height for 4 buffer zones 
